...
namespace UnityEngine.Advertisements
{
    ...
    public static class Advertisement
    {
        ...
        public static bool isInitialized
        {
            get
            {
                return s_Platform.isInitialized;
            }
        }
        ...
        /// <summary>
        /// <para>Loads ad content for a specified Placement. If you initialized the SDK with <c>enablePerPlacementLoad</c> enabled, you must call <c>Load</c> before calling <c>Show</c>.</para>
        /// <para>The <c>Load</c> API is in closed beta and available upon invite only. If you would like to be considered for the beta, please cantact unityads-support@unity3d.com.</para>
        /// </summary>
        /// <param name="placementId">The unique identifier for a specific Placement, found on the <a href="https://operate.dashboard.unity3d.com/">developer dashboard</a>.</param>
